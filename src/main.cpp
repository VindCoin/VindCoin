...
const string strMessageMagic = "vindcoin Signed Message:\n";
...
bool CTransaction::IsStandard() const
{
    ...
    BOOST_FOREACH(const CTxIn& txin, vin)
    {
        ...
        if(GetTransaction(txin.prevout.hash, txPrev, hashBlock)){  // get vin's previous transaction
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in vindcoin
    bool fStrictPayToScriptHash = true; // Always active in vindcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vindcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "December 06, Time For Vin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1449438989;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1541297;
        ...
        assert(block.hashMerkleRoot == uint256("c74f5de728ef360534bea6ef5413863335d99b2cdff956da7f4ee561cae03804"));
